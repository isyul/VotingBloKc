  ...
  describe('Poll Management', () => {
    describe('Success', () => {
      it('should confirm poll creation success', async () => {
        ...
        await contract.createPoll(title, description, starts, ends)
      ...
      it('should confirm poll update success', async () => {
        ...
        await contract.updatePoll(pollId, 'New Title', description, starts, ends)
    ...
    describe('Failure', () => {
      it('should confirm poll creation failures', async () => {
        ...
        await expectRevert(
          contract.createPoll(title, description, 0, ends),
      ...
      it('should confirm poll update failures', async () => {
        await expectRevert(
          contract.updatePoll(100, 'New Title', description, starts, ends),
          'Poll not found'
        )
      })
